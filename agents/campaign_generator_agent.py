...
"""
    ...
    def _generate_weather_campaign(self, weather_data: Dict, location: str, customers: List) -> Dict[str, Any]:
        ...
        for loc, loc_customers in location_groups.items():
            ...
            context = f"""
            Generate a weather-based vehicle service campaign for {loc}.
            ...
            Create ONE campaign for {loc} that will be sent to {len(loc_customers)} customers.
            Focus on weather-related vehicle maintenance needs for {loc} location.
            Address seasonal preparations and safety considerations relevant to current weather.
            """
    ...
    def _generate_holiday_campaign(self, holiday_data: Dict, location: str, customers: List) -> Dict[str, Any]:
        ...
        for loc, loc_customers in location_groups.items():
            ...
            context = f"""
            Generate a holiday-based vehicle service campaign for {loc}.
            ...
            Make it relevant to {loc} location context.
            """
